...
#define STRING_CONFIG_H_AUTHOR "(ScribbleJ, Rostock Max)" // Who made the changes.
...
#define CUSTOM_MENDEL_NAME "Scribble"
...
#define DELTA_SMOOTH_ROD_OFFSET 196.75 // mm
...
#define DELTA_FUDGE 5.0
//#define DELTA_FUDGE 5.5
...
#define PROBE_OFFSET_Z 4.2
//#define PROBE_OFFSET_Z 5.15
...
#define MANUAL_Z_HOME_POS 360.0
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 80, 405.54}  // default steps per unit for Kossel (GT2, 20 tooth)
#define DEFAULT_MAX_FEEDRATE          {300, 300, 300, 65}    // (mm/sec)
